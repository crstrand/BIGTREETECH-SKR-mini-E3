...
#define CUSTOM_USER_MENUS
  ...
  // each custom screen can contain 5 items
  #define USER_DESC_1 "Info & Home"
  #define USER_GCODE_1 "M503\nG28"

  #define USER_DESC_2 "Heat " PREHEAT_1_LABEL
  #define USER_GCODE_2 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define USER_DESC_3 "Heat " PREHEAT_2_LABEL
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)

  #define USER_DESC_4 "PID Tune Hotend"
  // start PID tune from ambient temperature
  #define USER_GCODE_4 "M109 R20\nM303 E0 S200 C5"

  #define USER_DESC_5 "PID Tune Bed"
  // start PID tune from ambient temperature
  #define USER_GCODE_5 "M109 R20\nM303 E-1 S60 C8"
